...
class ThoughtsControllerTest < ActionController::TestCase
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post :create, thought: { body: @thought.body, distress_level: @thought.distress_level, title: @thought.title, user_id: @thought.user_id }
    end
  ...
  test "should update thought" do
    patch :update, id: @thought, thought: { body: @thought.body, distress_level: @thought.distress_level, title: @thought.title, user_id: @thought.user_id }
    assert_redirected_to thought_path(assigns(:thought))
  end
